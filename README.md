...
## planned Improvements 
   * Split the following functions as they seems big ones (get_user_inputs, get_activity_details).
   * Replace the 'Global variables' with 'function arguments',
   * Make the API_KEY variable an environment variable instead.
   * Move the constant values to a file named 'constant.py', the values that are in the function 'recommondation' 
...
## planned Improvements 
   * Split the following functions as they seems big ones (get_user_inputs, get_activity_details).
   * Replace the 'Global variables' with 'function arguments',
   * Make the API_KEY variable an environment variable
